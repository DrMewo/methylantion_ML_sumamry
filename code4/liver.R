...
#a$para<-sapply(a[,alength],a$para,function(x,y) if(x=="c22"){y<-"liver"}else{y<-"other"})
#dt<-a
blength<-length(a[1,])
print(blength)
...
for(td in TODO) {
  ...
  file_path = '/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/model3/liver/'
