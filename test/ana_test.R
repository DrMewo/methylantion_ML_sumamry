...
#hope("/mnt/ilustre/users/sanger-dev/sg-users/shenyiru/ctDNA/GEO_DB/GSE37754.Rd")

#hope<-function(path_param){

path_param = "/mnt/ilustre/users/sanger-dev/sg-users/shenyiru/ctDNA/GEO_DB/GSE37754.Rd"
...
last_out_put_chr_all<-cbind(last_out_put_chr_all,out_put_chr_all)
last_out_put_chr_samll<-cbind(last_out_put_chr_samll,out_put_chr_samll)
last_out_put_num_all<-cbind(last_out_put_num_all,out_put_num_all)
last_out_put_num_samll<-cbind(last_out_put_num_samll,out_put_num_samll)
