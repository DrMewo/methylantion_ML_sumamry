...
a<-read.delim("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/test_yf/brca.2.beta.txt",header=F)
...
out_put_chr_all[1,2]<-message_names[1]
out_put_chr_samll[1,2]<-message_names[1]
out_put_num_all[1,2]<-message_names[1]
out_put_num_samll[1,2]<-message_names[1]
