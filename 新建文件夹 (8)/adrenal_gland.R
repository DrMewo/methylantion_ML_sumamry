...
a[which(a[,alength]=='c72'|a[,alength]=='c74'|a[,alength]=='c75'|a[,alenth]=='c76'),blength]<-"adrenal_gland"
...
for(td in TODO) {
  ...
  file_path = '/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/model/adrenal_gland/'
