...
for(k in c(1:30)){
     para_name<-paste("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_para/8/data",k,sep="_")
...
para_name_summary_10<-paste("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_para/8/data_summary_10",k,sep="_")
