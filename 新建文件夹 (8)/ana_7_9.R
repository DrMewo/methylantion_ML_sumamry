...
print(2)
for(k in c(1:30)){
para_name_summary<-paste("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_para/9/data_summary",k,sep="_")
...
print("fuck")
print(data_ak)
para_name_summary_1<-paste("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_para/9/data_kmeans",k,sep="_")
para_name_summary_1<-paste(para_name_summary_1,".txt",sep="")
write.table(data_ak,para_name_summary_1,sep="\t",row.names = FALSE)
print("fuckfuckfuck")
print(data_ak2)
para_name_summary_2<-paste("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_para/9/data_kmeans_sum",k,sep="_")
