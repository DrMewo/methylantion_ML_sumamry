...
a<-read.delim("/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_all/data_10_7_ana.txt")
...
write.table(pvalue,"/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_all/analysis_2_7_10_F.txt",sep="\t",row.names=F)
write.table(pvalue,"/mnt/ilustre/users/sanger-dev/sg-users/zhangpeng/fighting/data_all/analysis_2_7_10_T.txt",sep="\t")
